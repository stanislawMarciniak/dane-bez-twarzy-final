...
SYNTHETIC_POOL: Dict[str, List[Any]] = {
    ...
    'surname-woman': [
        'Nowak', 'Kowalska', 'Wiśniewska', 'Wójcik', 'Kowalczyk', 'Lewandowska',
        'Zielińska', 'Szymańska', 'Woźniak', 'Dąbrowska', 'Kozłowska', 'Jankowska',
        'Mazur', 'Wojciechowska', 'Kwiatkowska', 'Kaczmarek', 'Krawczyk', 'Piotrowska',
        'Grabowska', 'Zając', 'Pawłowska', 'Michalska', 'Nowicka', 'Adamczyk',
        'Dudek', 'Nowakowska', 'Stępień', 'Wróbel', 'Zalewska', 'Jasińska',
        'Kruk', 'Gajewska', 'Sikora', 'Szczepańska', 'Walczak', 'Baran', 'Głowacka',
        'Szewczyk', 'Ostrowska', 'Górecka', 'Chmielewska', 'Bąk', 'Włodarczyk',
        'Czarnecka', 'Sawicka', 'Lis', 'Klimczak', 'Sokołowska', 'Wieczorek',
        'Jaworska', 'Borkowska', 'Witkowska', 'Marciniak', 'Olszewska', 'Krupa',
        'Pawlak', 'Kozak', 'Barańska', 'Szewc', 'Cieslak', 'Ziobro', 'Konieczny',
        'Błaszczyk', 'Gajda', 'Kubiak', 'Kopeć', 'Mazurek', 'Królikowska', 'Klimek'
    ],
    ...
    'city': ['Warszawa', 'Kraków', 'Gdańsk', 'Poznań', 'Wrocław', 'Łódź', 'Szczecin', 'Katowice'],
    'email_domain': ['gmail.com', 'poczta.onet.pl', 'wp.pl', 'vp.pl', 'sklep.pl', 'buziaczek.pl', 'info.pl',
                     'tech.com'],

    # 4. Dane zawodowe i edukacyjne (Z PODZIAŁEM NA PŁEĆ)
    'company': ['EkoBud Sp. z o.o.', 'TechNet S.A.', 'Global Consulting', 'Kancelaria Prawna LEX',
                'Instytut Badań Naukowych', 'Sklep Zoologiczny FAF', 'Media Expert', 'PZU'],
    'school-name': ['Liceum nr 5 w Poznaniu', 'Uniwersytet Jagielloński', 'Politechnika Warszawska',
                    'Szkoła Podstawowa nr 2'],
    'job-title-man': ['inżynier oprogramowania', 'specjalista ds. kadr', 'analityk finansowy', 'lekarz',
                      'kierownik budowy', 'programista', 'ekonomista'],
    'job-title-woman': ['inżynierka oprogramowania', 'specjalistka ds. kadr', 'analityczka finansowa', 'lekarka',
                        'kierowniczka budowy', 'programistka', 'ekonomistka'],
    ...
    'relative-man': ['brat', 'mąż', 'ojciec', 'syn', 'dziadek', 'kolega'],
